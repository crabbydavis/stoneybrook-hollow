...
export class FaqPage {
  ...
  faqs: FAQ[] = [
    ...
    { question: `Can I come tour the studio?`, answer: `Yes! Please ontact Miss Anna to schedule a time.` },
    ...
    { question: `What precautions are in place to keep my child safe?`, answer: `All guides, including Anna’s husband Davis (who works in the home), have passed a background check. Anna maintains an up-to-date CPR and first-aid certification. All doors into our home will remain locked during school hours. Children will be signed in and out by authorized adults each day. Children practice fire, earthquake and intruder drills throughout the year. Due to our small child-to-adult ratio, we are able to maintain close supervision at all times.` },
    ...
    { question: `I want to learn more about your learning philosophy!`, answer: `<a href="https://www.instagram.com/stoneybrookhollow/" target="_blank">Follow us on Instagram or Facebook to see how our philosophy works in action!</a>` }
  ];
