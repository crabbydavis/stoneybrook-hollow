...
export class FaqPage {
  ...
  faqs: FAQ[] = [
    ...
    { question: `Will my child learn about diversity at Stoneybrook Hollow?`, answer: `Yes! We aim to foster beliefs of advocacy, inclusion and empathy for all. We welcome children from all backgrounds and circumstances. We strive to create a rich learning environment where many cultures, bodies, skin-tones, abilities, orientations and beliefs are represented. For example, children will learn ASL vocabulary in the studio to communicate with our son who has CHARGE syndrome. <a href="https://onlinelibrary.wiley.com/doi/abs/10.1111/desc.12788" target="_blank">Research shows</a> children as young as four years old have already begun to show implicit bias. All learning to combat this will be developmentally appropriate and research-based. We are deeply committed to transparency with this endeavor - please contact us if you have further questions.` },
