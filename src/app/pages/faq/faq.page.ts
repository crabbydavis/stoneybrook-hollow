...
export class FaqPage {
  ...
  faqs: FAQ[] = [
    ...
    { question: `Where are you located?`, answer: `We’re located at 416 S Mountain Rd, Fruit Heights, UT. We are a 9 minute walk to mountain trails and a 13 minute walk to creek access at Nicholls Park. Bonus: we’ve got a bus stop across the street for community-oriented field trips!<br><br>Our indoor space has tons of natural lights and large classrooms with tons of room to play and be free. Our outdoor space includes a large (.45 acre), fenced-in FOREST!` },
    ...
    { question: `What is the teacher-student ratio?`, answer: `We have 12 children and two guides each day. We maintain a 1:6 ratio at all times.<br><br>Miss Anna is the lead guide, assisted by Miss Kait and Miss Steph.` },
    ...
    { question: `Can I come tour the studio?`, answer: `Yes! Please contact Miss Anna to schedule a time.` },
    ...
    { question: `What precautions are in place to keep my child safe?`, answer: `All guides and Anna’s husband, Davis (who works in the home), have passed a background check. Anna maintains an up-to-date CPR and first-aid certification. All doors into our home will remain locked during school hours. Children will be signed in and out by authorized adults each day. Children practice fire, earthquake and intruder drills throughout the year. Due to our small child-to-adult ratio, we are able to maintain close supervision at all times.` },
    ...
    { question: `I want to learn more about your learning philosophy!`, answer: `Follow us on <a href="https://www.instagram.com/stoneybrookhollow/" target="_blank">Instagram</a> or <a href="https://www.facebook.com/stoneybrookhollowstudio" target="_blank">Facebook</a> to see our philosophy in action!` }
  ];
