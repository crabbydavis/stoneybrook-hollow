...
export class FaqPage {
  ...
  faqs: FAQ[] = [
    ...
    { question: `Where are you located?`, answer: `We are near Morgan Elementary in east Kaysville, Utah. The studio is in the spacious, above-ground basement of our home. It is clean, warm and flooded with natural light. Our outdoor space is magical! We have a wooded yard, child-grown garden,  babbling creek, blackberry bushes and winding footpaths to explore. For privacy reasons, please contact us for the exact address.` },
    { question: `How much is tuition?`, answer: `Tuition is $225 a month. A $100 deposit is required upon enrollment to save your spot and will go towards last month's tuition. <br><br>We believe all children have a right to a quality early childhood education. We hope to transition to a 501-3c non-profit organization in the near future in efforts to provide full scholarships. Funding for Kindergarteners, First Graders and students with learning disabilites may be available. Please contact us for more information.` },
    ...
    { question: `Can I come tour the studio?`, answer: `Yes! Contact us to schedule a tour.` },
    ...
    { question: `Can Stoneybrook Hollow accommodate my child with special needs?`, answer: `We have a child with special needs ourselves! We are passionate about advocating for all children, especially those with unique needs. Please contact us about your specific learner. We would love to provide a tailored learning experience for your child within our area of expertise. We cannot provide nurses or therapists at this time. If your child has a nurse, we welcome them in our studio. If your child has a learning disability, funding may be available. Please contact us for more information.` },
